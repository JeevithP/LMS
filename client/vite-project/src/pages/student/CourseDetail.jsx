...
import { useGetNumberOfStudentsQuery } from '@/features/api/courseApi';
...
export default function CourseDetail() {
    ...
    const {data:numberOfStudentsData}=useGetNumberOfStudentsQuery(courseId);
    const numberOfStudents=numberOfStudentsData?.count || 0;
    console.log(numberOfStudentsData);
        ...
        <div className='space-y-5 '>
            <div className='bg-[#2D2F31] text-white'>
                <div className='max-w-7xl mx-auto py-8 px-4 md:px-8 flex flex-col gap-2'>
                    ...
                    <p>Students Enrolled: {numberOfStudents}</p>
                </div>
            </div>
